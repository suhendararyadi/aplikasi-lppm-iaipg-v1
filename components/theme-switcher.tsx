...
export default async function VerifikasiLaporanPage({
  ...
  // Tidak perlu await searchParams karena tidak digunakan dalam komponen ini
  // Jika nanti digunakan, bisa di-await seperti: const resolvedSearchParams = await searchParams;
